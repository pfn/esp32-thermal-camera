...
// modification of <Fonts/FreeSans9pt7b.h> to fix spacing of = and +

const uint8_t _FreeSans9pt7bBitmaps[] PROGMEM = {
  ...
  0b00111111, 0b00111001, 0b11111000, 0b01111000, 0b00001110, 0b00000011, 0b10000000, 0b11110000,
  0b11100000, 0b11100000, 0b01100000, 0b00111000, 0b01101110, 0b01110011, 0b11110000, // epsilon
    // 0x61, 0x24, 0x38}; // ~
    0b00111000, 0b10001010, 0b00001100, 0b00011000, 0b00101000, 0b10001110, 0}; // degrees
    // };

const GFXglyph _FreeSans9pt7bGlyphs[] PROGMEM = {
    {0, 0, 0, 5, 0, 1},        // 0x20 ' '
    {0, 2, 13, 6, 2, -12},     // 0x21 '!'
    {4, 5, 4, 6, 1, -12},      // 0x22 '"'
    ...
    {1133, 8, 8, 8, 2, -11},  // 0x7C '|' => square
    //{1138, 4, 17, 6, 1, -12},  // 0x7D '}'
    {1141, 9, 13, 11, 1, -12},  // '}' => epsilon
    {1156, 7, 7, 8, 2, -12}};   //  '~' => degree symbol
    // {1147, 7, 3, 9, 1, -7}};   // 0x7E '~'

const GFXfont _FreeSans9pt7b PROGMEM = {(uint8_t *)_FreeSans9pt7bBitmaps,
                                       (GFXglyph *)_FreeSans9pt7bGlyphs, 0x20,
                                       0x7E, 22};

// Approx. 1822 bytes

const uint8_t snowflake[] PROGMEM = {
  0xff, 0xff, 0xff, 0x00, 0xff, 0xff, 0xff,
  0xff, 0x00, 0x01, 0x00, 0x01, 0x00, 0xff,
  0xff, 0x01, 0x00, 0x00, 0x00, 0x01, 0xff,
...
const uint8_t sun[] PROGMEM = {
  0xff, 0x01, 0x00, 0x00, 0x00, 0x01, 0xff,
  0x01, 0x00, 0xff, 0xff, 0xff, 0x00, 0x01,
  0x00, 0xff, 0x01, 0x01, 0x01, 0xff, 0x00,
  0x00, 0xff, 0x01, 0x00, 0x01, 0xff, 0x00,
  0x00, 0xff, 0x01, 0x01, 0x01, 0xff, 0x00,
  0x01, 0x00, 0xff, 0xff, 0xff, 0x00, 0x01,
  0xff, 0x01, 0x00, 0x00, 0x00, 0x01, 0xff,
};
